...
class Admin extends CI_Controller
{
    ...
    public function editrole()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Edit role succeed!</div>');
    ...
    {
        $this->menu->delete(['id' => $this->uri->segment(3)], 'user_role');
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Delete role succeed!</div>');
        // hanya beralih seakan-akan baru datang
        redirect('admin/role');
    }
}
